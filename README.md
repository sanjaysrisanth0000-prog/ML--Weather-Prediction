...
## Algorithm
Step 1:
Load and preprocess the dataset using pandas by cleaning columns, sorting time data, and handling missing values.

Step 2:
Perform feature engineering by creating time-based features (sin, cos) and lag features using NumPy.

Step 3:
Split the data into training and testing sets, then train the model using Random Forest Regression.

Step 4:
Evaluate the model performance and predict future weather values, then visualize the results using Matplotlib. 
...
## Output:
<img width="639" height="831" alt="image" src="https://github.com/user-attachments/assets/af2d772c-3f01-4d54-ac46-3dc086c14829" />
